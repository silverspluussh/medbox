...
import '../reminders/reminders_main.dart';
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            children: [
                              ...
                              Badge(
                                smallSize: 10,
                                backgroundColor: alarmactive == true
                                    ? Colors.green
                                    : Colors.red,
                                                                  ...
                                                                  child: Container(
                                                                      ...
                                                                      child: Column(
                                                                        ...
                                                                        children: [
                                                                          inputformfield(
                                                                              width: size.width - 50,
                                                                              hinttext: medication[index].medicinename,
                                                                              title: 'Medicine name',
                                                                              controller: medname),
                                                                          inputformfield(
                                                                              width: size.width - 50,
                                                                              title: 'Dosage',
                                                                              hinttext: medication[index].dose!,
                                                                              controller: dose),
                                                                          inputformfield(
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              MModel mModel = MModel(
                                                                                dose: dose.text.isNotBlank ? dose.text : medication[index].dose,
                                                                                image: medication[index].image,
                                                                                id: medication[index].id,
                                                                                medicinename: medname.text.isNotBlank ? medname.text : medication[index].medicinename,
                                                                                medicinetype: medicinetype.text.isNotBlank ? medicinetype.text : medication[index].medicinetype,
                                                                              );
                                                                              MedicationsDB().updatemedicine(mModel).then((value) {
                                                                                setState(() {});
                                                                                Navigator.pop(context);
                                                                              });
                                                                            },
