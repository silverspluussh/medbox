...
class _UpdateProfileState extends ConsumerState<UpdateProfile> {
  ...
  void initState() {
    ...
    widget.pm.first.allergies!.isNotEmpty
    ...
    //
    widget.pm.first.healthConditions!.isNotEmpty
        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverList(
              ...
              FormfieldX(
                controller: dob,
                hinttext: widget.pm.first.dob ?? ' d/m/y',
                ...
                suffix: IconButton(
                    ...
                    icon: const Icon(Icons.calendar_view_day, color: kprimary)),
                label: AppLocalizations.of(context)!.dob,
              ),
              const SizedBox(height: 10),
              FormfieldX(
                controller: address,
                hinttext: widget.pm.first.homeAddress ??
                    'eg. Kumasi Ayeduase New site',
              ...
              FormfieldX(
                ...
                hinttext: 'seperate allergies with a comma (nuts,milk,etc)',
                inputType: TextInputType.name,
                readonly: false,
              ...
              Visibility(
                ...
                child: Row(
                  children: [
                    ...allergic.map((e) => Card(
                          color: e.isNotEmpty ? Colors.teal : kBackgroundColor,
