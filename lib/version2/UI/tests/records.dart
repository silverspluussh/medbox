...
class Mrecords extends ConsumerWidget {
  const Mrecords({super.key});
      ...
      body: CustomScrollView(
        slivers: [
          const SliverAppBar(
            floating: true,
            toolbarHeight: 40,
            title: Ltxt(text: 'My Medical Records'),
            centerTitle: true,
          ),
          tests.when(
                  ...
                  itemBuilder: (context, index) => t.isEmpty
                      ...
                      : Container(
                          ...
                          decoration: BoxDecoration(
                              color: medColor[index % 5].withOpacity(0.05),
                              border: const Border(
